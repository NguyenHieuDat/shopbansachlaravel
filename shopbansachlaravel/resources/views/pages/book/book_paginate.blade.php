        ...
        <div class="col-lg-2-4 col-md-4 col-sm-6 pb-1">
            <div class="product-item bg-light mb-4">
                ...
                <div class="text-center py-4">
                    <a class="h6 text-decoration-none text-truncate book-name" title="{{$book->book_name}}" data-bs-toggle="tooltip" 
                    style="max-width: 100%; margin: 0 auto; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">{{$book->book_name}}</a>

                    <div class="d-flex align-items-center justify-content-center mt-2">
                        <h5 style="color: #dc3545">{{number_format($book->book_price).' '.'đ'}}</h5>
                    </div>
